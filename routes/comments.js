...
// middleware we add middleware.isLoggedIn bc we have the middle "isLoggedIn" in another dir
...
router.get("/new", middleware.isLoggedIn ,function(req, res) {
  // every time you need some info to give to a page you need to first find it and then pass
    ...
    if(err){
      ...
      Comment.create(req.body.comment,function(err, comment){
        if(err){
          ...
          // this will add the connect tio particular user and save it
...
// lets add a middleware like we did in campground check ownership
