...
// // when calle dit wil wipe all data in dbs 
// function seedDB(){
...
// same as above but this will cancell and add new data 
function seedDB(){
    //this will wipe all data in db 
    Campground.remove({}, function(err){
        // if(err){
        ...
        //         // this will create a neew cooment each time the loop goes aka for all the posts 
        //         Comment.create(
        //             {
